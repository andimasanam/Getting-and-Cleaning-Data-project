...
mean() : mean values of multiple measurements of the original variables. Data Type: Real number

std(): Standard deviation of multiple measurements of the original variables. Data Type: Real number

activity_id: Identifier, identifying the activity of each subject Data Type: Integer Values: 1 : 6
...
subject_id : Identifier, identifying each subject Data Type: Integer Values: 1 : 30
